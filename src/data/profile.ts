...
export const goals = [
  ...
  {
    label: 'なぜQA？',
    body: 'ユーザと開発者のためです。便利なものは使っていて心地良いものだと思います。これは品質の一つの要素であると考えています。また、検証作業は開発工程の中でも特に工数がかかり、作業として好まない人もいる領域と捉えています。そこで、検証にかかるコストをテスト自動化やプロセスで最適化し、開発者にとっても便利で開発しやすい環境を作る。結果として、開発者は快適に機能を作れるし、ユーザには素早く便利なソフトウェアが届く。これがQAの目指す姿の一つだと思っています。',
  },
]
